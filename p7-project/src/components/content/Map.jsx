...
const MapTest = () => {
  ...
  const fetchMapboxToken = async () => {
    ...
    if (isDevelopment) {
      console.log('Development mode: using hardcoded Mapbox token');
    ...
    try {
      ...
      setMapboxToken(data.accessToken);
      return data.accessToken;
    } catch (error) {
      console.error('Error fetching Mapbox token from API:', error);
      console.log('Falling back to hardcoded token for development');
  ...
  // Ordinary function: clear all music markers
  ...
  // Ordinary function: load music data and create markers
